...
public class Project {
    ...
    public static void Add(LinkedList b) {
        ...
        while (true) { 
            ...
            if (specific == '0') {
                ...
                boolean retval = b.Add(title, author, cat, 0, 0);
                if (retval){
                    System.out.println();
    ...
    public static void main(String[] args) {
            ...
            switch (choice) {
                case 1:// Add page
                    ...
                    while (true) {
                        ...
                        while (true) {            
                            try {
                                System.out.println("Enter 0 if you want to return to main menu");
                        ...
                        if (ch == 6) {
                            ...
                            System.out.println("Please enter 0 or 6");
                        }
                    }
                    break;
                case 2://update
        ...
        System.out.println("Thank You (✿◠‿◠)");
    }
